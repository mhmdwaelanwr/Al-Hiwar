...
import 'package:bookly/core/common/special_appbar_with_back_arrow.dart';
import 'package:bookly/core/common/special_drawer.dart';
import 'package:flutter/material.dart';

class SpecialScaffoldWithBackgroundWithBackArrow extends StatelessWidget {
  const SpecialScaffoldWithBackgroundWithBackArrow({
    super.key,
    required this.body,
